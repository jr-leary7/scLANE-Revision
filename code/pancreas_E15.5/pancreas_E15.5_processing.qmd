...
Finally, in order to validate the links between transcription factors and target genes, we build a gene regulatory network (GRN) using the `GENIE3` package. This process takes a while to complete, so we utilize 16 threads to speed things up. 
