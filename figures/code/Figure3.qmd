...
names(palette_genes) <- c("Sox9", "Neurog3", "Nkx2-2", "Rfx6", "Neurod1", "Arx", "Pax6", "Pax4", "Pdx1", "Ins1")
...
#| fig-width: 2
#| fig-height: 2.5
fig = plt.figure(figsize=(2, 2.5), dpi=300)
...
#| message: false
#| warning: false
beta_genes <- c("Neurod1", "Nkx2-2", "Pax4", "Pdx1")
...
Fig_3G <- select(seu_panc@meta.data, 
          ...
          mutate(gene_program_label = case_when(gene_program == "Leiden_1" ~ "Cell cycle" , 
                                                gene_program == "Leiden_2" ~ "Cell localization" , 
                                                gene_program == "Leiden_3" ~ "Peptide secretion", 
                                                gene_program == "Leiden_4" ~ "Endocrine differentiation", 
                                                gene_program == "Leiden_5" ~ "Ductal housekeeping", 
                                                gene_program == "Leiden_6" ~ "Ductal differentiation", 
                                                TRUE ~ NA_character_)) %>% 
          arrange(score) %>% 
...
```{r}
round(scLANE_models$Neurog3$Lineage_A$Gene_Dynamics$Breakpoint2, 3)
round(scLANE_models$Neurog3$Lineage_A$Gene_Dynamics$Slope.Segment3, 3)
```

```{r}
round(scLANE_models$Arx$Lineage_A$Gene_Dynamics$Breakpoint2, 3)
round(scLANE_models$Arx$Lineage_A$Gene_Dynamics$Slope.Segment3, 3)
```
...
```{r}
round(scLANE_models$`Nkx2-2`$Lineage_A$Gene_Dynamics$Breakpoint2, 3)
round(scLANE_models$Neurod1$Lineage_A$Gene_Dynamics$Breakpoint2, 3)
```
...
round(scLANE_models$Grasp$Lineage_A$Gene_Dynamics$Breakpoint, 3)
round(mean(c(scLANE_models$Btbd17$Lineage_A$Gene_Dynamics$Breakpoint, 
             ...
             scLANE_models$Cdc14b$Lineage_A$Gene_Dynamics$Breakpoint,
             scLANE_models$Grasp$Lineage_A$Gene_Dynamics$Breakpoint)), 3)
mean(c(scLANE_models$Hes6$Lineage_A$Gene_Dynamics$Slope.Segment2,
       ...
       scLANE_models$Grasp$Lineage_A$Gene_Dynamics$Slope.Segment1))
```
