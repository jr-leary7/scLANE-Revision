...
```{r}
plotModels(scLANE_models, gene = "SP140", pt = pt_df_sort, expr.mat = seu_bcell_sort, size.factor.offset = cell_offset_sort, is.gee = TRUE, id.vec = seu_bcell_sort$fetal.ids, plot.gam = TRUE, plot.null = TRUE, plot.glm = TRUE)
```
