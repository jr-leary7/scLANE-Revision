...
ax.set_xlabel('FA 1')
ax.set_ylabel('FA 2')
ax.set_xlim(ad_myeloid.obsm['X_draw_graph_fa'][:, 0].min() - 2000, ad_myeloid.obsm['X_draw_graph_fa'][:, 0].max() + 2000)
ax.set_ylim(ad_myeloid.obsm['X_draw_graph_fa'][:, 1].min() - 2000, ad_myeloid.obsm['X_draw_graph_fa'][:, 1].max() + 2000)
