...
smoothed_counts <- smoothedCountsMatrix(scLANE_models, 
                                        ...
                                        log1p.norm = TRUE)
gene_embed <- embedGenes(smoothed_counts$Lineage_A, resolution.param = 0.25) %>% 
...
View(with_groups(enrich_res, query, slice_head, n = 10))
...
S_Fig_5C <- mutate(embed_df_sort, 
            ...
            mutate(program_label = case_when(program == "cluster_1" ~ "B-cell Activation", 
                                             ...
                                             program == "cluster_3" ~ "Differentiation", 
                                             program == "cluster_4" ~ "Ribosome Biogenesis", 
                                             TRUE ~ NA_character_)) %>% 
